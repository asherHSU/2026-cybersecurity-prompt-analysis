...
RMCBench is released under the CC-BY-4.0 license.

You are free to use, modify, and redistribute the dataset with proper attribution.

If you use RMCBench, please cite.
