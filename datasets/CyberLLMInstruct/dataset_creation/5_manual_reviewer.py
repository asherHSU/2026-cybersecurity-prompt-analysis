...
class CyberDataReviewer:
    ...
    def process_directory(self):
        ...
        # Get reviewer ID (auto-set for non-interactive mode)
        import argparse as _ap
        _parser = _ap.ArgumentParser(add_help=False)
        _parser.add_argument('--reviewer-id', default='auto_reviewer')
        _args, _ = _parser.parse_known_args()
        reviewer_id = _args.reviewer_id
...
def main():
    ...
    _p2.add_argument('--input-dir', default='domain_classified')
    _p2.add_argument('--output-dir', default='reviewed_data')
    _p2.add_argument('--reviewer-id', default='auto_reviewer')
    _a2, _ = _p2.parse_known_args()
    reviewer = CyberDataReviewer(input_dir=_a2.input_dir, output_dir=_a2.output_dir)
